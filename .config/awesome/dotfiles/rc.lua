...
local br, br_signal = awful.widget.watch(os.getenv("HOME") .. '/scripts/brightness-bar.sh', 60, function(self, stdout)
...
local vo, vo_signal = awful.widget.watch(os.getenv("HOME") .. '/scripts/volume-bar.sh', 60, function(self, stdout)
	local vol = stdout
